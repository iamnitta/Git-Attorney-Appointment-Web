  ...
  return (
    <div className="w-full bg-light-brown">
      <div className="flex flex-col items-center gap-4 py-16 text-black md:mx-10">
        <h1 className="text-3xl font-medium font-prompt">ค้นหาทนายความ</h1>
        <p className="sm:w-1/3 text-center text-sm font-prompt text-dark-brown font-medium md:text-2xl">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 pt-5 px-3 place-items-center">
          {lawyers.slice(0, 9).map((item, index) => (
            <div
        ...
        <button
          ...
          className="bg-brown-lawyerpic px-12 py-3 rounded-full mt-10 font-prompt text-dark-brown font-medium hover:scale-105 transition-all duration-300"
        >
          ทนายความทั้งหมด
        </button>
      </div>
